...
const EditVolunteersPage = () => {
  ...
  useEffect(() => {
      if (typeof volunteers === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (volunteers)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit volunteers'} main>
        {''}
  ...
  <FormField label='User' labelFor='user'>
        ...
        ></Field>
              ...
              <BaseButtons>
                ...
                <BaseButton type='reset' color='danger' outline label='Cancel' onClick={() => router.push('/volunteers/volunteers-list')}/>
              </BaseButtons>
            </Form>
          </Formik>
        </CardBox>
