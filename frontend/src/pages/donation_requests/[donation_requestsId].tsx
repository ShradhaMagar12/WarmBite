...
const EditDonation_requests = () => {
  ...
  const { donation_requestsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: donation_requestsId }))
  }, [donation_requestsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: donation_requestsId, data }))
...
EditDonation_requests.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditDonation_requests
